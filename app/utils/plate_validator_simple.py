...
class SimplePlateValidator:
    """Simple validator with OCR error tolerance"""
...
if __name__ == "__main__":
    ...
    print('🧪 Simple OCR Error Correction Test:')
    print('Original    | Valid | Normalized | Type')
    print('-' * 45)
    
    validator = SimplePlateValidator()
    for plate in test_plates:
        is_valid, normalized, plate_type = validator.validate_and_normalize(plate)
